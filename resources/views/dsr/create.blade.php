        ...
        <div class="card card-primary card-outline card-outline-tabs">     
          <div class="card-header p-0 border-bottom-0">
            <ul class="nav nav-tabs" id="nav-tab" role="tablist">
                ...
                <li class="nav-item">
                <a class="nav-link" id="nav-status-tab" data-toggle="pill" href="#nav-status" role="tab" aria-controls="nav-status" aria-selected="false">Details</a>
            </ul>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            ...
            <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask name="mobile_eclosing_date" id="datemask">
                              </div>
                              <!-- /.input group -->
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="mobile_erevenue" placeholder="1000" />
                            </div>
                        </div>
                ...
                <div class="tab-pane fade" id="nav-fixed" role="tabpanel" aria-labelledby="nav-fixed-tab">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask name="fixed_eclosing_date" id="fdatemask">
                              </div>
                              <!-- /.input group -->
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            <div class="form-group">
                                <label>Expected revenue:</label>
                                <input type="text" class="form-control" name="fixed_erevenue" placeholder="1000" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-4"></div>
                    </div>
                ...
                <div class="tab-pane fade" id="nav-status" role="tabpanel" aria-labelledby="nav-status-tab">
                    <div class="row">
                         <div class="col-xs-12 col-sm-12 col-md-12">
                          <div id="frmstatus">
                          <input type="hidden" class="form-control" name="order_status" id="ostatus" value="14"></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 col-sm-3 col-md-3">
